...
/**
 * A builder for creating {@link org.mal_lang.langspec.step.StepDifference} objects.
 *
 * @since 1.0.0
 */
public final class StepDifferenceBuilder extends StepBinaryOperationBuilder {
  /**
   * Constructs a new {@code StepDifferenceBuilder} object.
   *
   ...
   * @since 1.0.0
   */
  public StepDifferenceBuilder(StepExpressionBuilder lhs, StepExpressionBuilder rhs) {
    super(lhs, rhs);
  }
