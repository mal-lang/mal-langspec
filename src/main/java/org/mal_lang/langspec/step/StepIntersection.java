 ...
 * @since 1.0.0
 */
public final class StepIntersection extends StepBinaryOperation {
  private StepIntersection(
  ...
  public JsonObject toJson() {
    return this.toJson("intersection");
  }

  static StepIntersection fromBuilder(
      StepIntersectionBuilder builder,
      Asset sourceAsset,
    ...
    return new StepIntersection(sourceAsset, targetAsset, lhs, rhs);
  }
}
