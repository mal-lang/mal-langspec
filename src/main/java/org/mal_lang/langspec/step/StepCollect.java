 ...
 * @since 1.0.0
 */
public final class StepCollect extends StepBinaryOperation {
  private StepCollect(
  ...
  public JsonObject toJson() {
    return this.toJson("collect");
  }

  static StepCollect fromBuilder(
      StepCollectBuilder builder,
      Asset sourceAsset,
    ...
    var rhs =
        StepExpression.fromBuilder(builder.getRhs(), lhs.getTargetAsset(), assets, variableTargets);
    return new StepCollect(sourceAsset, rhs.getTargetAsset(), lhs, rhs);
  }
}
